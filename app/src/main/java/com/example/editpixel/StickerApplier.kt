...
class StickerApplier : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            StickerWrapper(imageBitmap = imageBitmap)
        }
    }
    ...
    @Composable
    fun StickerWrapper(imageBitmap: ImageBitmap) {
        ...
        Column(
            ...
            if (croppedImageBitmap.value != null) {
                ...
                val stickerWidth = croppedImageBitmap.value!!.width
                val stickerHeight = croppedImageBitmap.value!!.height
                ...
                Row(
                    ...
                    Button(onClick = {
                        ...
                        val tempBitmap: Bitmap = imageBitmap.asAndroidBitmap().copy(Bitmap.Config.ARGB_8888, false)
                        canvas.drawBitmap(tempBitmap, 0f, 0f, null)
                        canvas.drawBitmap(croppedImageBitmap.value!!.asAndroidBitmap(), offsetX, offsetY, null)
                        val resultImageBitmap = resultBitmap.asImageBitmap()

                        BitmapObject.bitmap = resultBitmap
                ...
                BoxWithConstraints {
                    ...
                    Canvas(modifier = Modifier
                        .size(min(boxWidth, imageWidth.dp), min(boxHeight, imageHeight.dp))
                        .clipToBounds()
                        .pointerInput(Unit) {
                            detectDragGestures { change, dragAmount ->
                                ...
                                offsetX = (offsetX + dragAmount.x).coerceIn(
                                    0f,
                                    (imageWidth - stickerWidth).toFloat()
                                )
                                offsetY = (offsetY + dragAmount.y).coerceIn(
                                    0f,
                                    (imageHeight - stickerHeight).toFloat()
                                )
                            }
                        }
                    )
                    {
                        ...
                        drawImage(croppedImageBitmap.value!!, topLeft = Offset(offsetX, offsetY))
                    }
                }
